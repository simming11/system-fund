...
export default function InternalScholarShipsPage() {
  ...
  useEffect(() => {
    const fetchScholarshipsData = async () => {
      try {
        ...
        // Filter scholarships by TypeID === 1 (ทุนการศึกษาภายใน)
        const filteredScholarships = scholarshipsData.filter((scholarship: Scholarship) => scholarship.TypeID === 1);

        // Fetch and attach images for each scholarship
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <h1 className="text-2xl font-semibold mb-6 text-center md:text-left">ทุนการศึกษาภายในคณะ</h1>
